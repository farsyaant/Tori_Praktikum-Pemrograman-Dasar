...
#include <math.h> // menyertakan perpustakaan math.h untuk fungsi pada operasi matematika
...
// pemberi jarak antara input dengan output
    ...
    if (diskriminan > 0) // percabangan yang memuat ekspresi 
        {   // kalkulasi yang dilakukan jika ekspresi bernilai benar
            ...
            cout << "Terdapat dua akar riil yang berbeda: " << endl;
            cout << "x1 = " << x1 << endl;
            cout << "x2 = " << x2 << endl;  }
        else // cabang lain jika ekspresi bernilai salah
            if (diskriminan == 0) 
            {   x = (-b)/(2*a);
                cout << "Terdapat dua akar riil yang yang sama." << endl;
                cout << "x = " << x << endl;}
